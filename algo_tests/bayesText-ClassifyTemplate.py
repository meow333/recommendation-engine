...
trainingDir = "/Users/raz/Downloads/20news-bydate/20news-bydate-train/"
# (just create an empty file to use as a stoplist file.)
stoplistfile = "/Users/raz/Downloads/20news-bydate/emptyStoplist.txt"

bT = BayesText(trainingDir, stoplistfile)
print("Running Test ...")
result = bT.classify("/Users/raz/Downloads/20news-bydate/20news-bydate-test/rec.motorcycles/104673")
print(result)
result = bT.classify("/Users/raz/Downloads/20news-bydate/20news-bydate-test/sci.med/59246")
print(result)
result = bT.classify("/Users/raz/Downloads/20news-bydate/20news-bydate-test/soc.religion.christian/21424")
print(result)
